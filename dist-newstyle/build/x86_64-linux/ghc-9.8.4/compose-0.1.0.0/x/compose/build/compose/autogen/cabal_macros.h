...
/* package compose-0.1.0.0 */
#ifndef VERSION_compose
#define VERSION_compose "0.1.0.0"
#endif /* VERSION_compose */
#ifndef MIN_VERSION_compose
#define MIN_VERSION_compose(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_compose */
...
#define CURRENT_COMPONENT_ID "compose-0.1.0.0-inplace-compose"
